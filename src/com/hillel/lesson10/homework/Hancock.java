...
final public class Hancock extends ActionMovie {

    private String budget;
    private String filmCompany;

    public Hancock(String mainGenre, String producer, String filmName, String dateOfIssue, String budget, String filmCompany) {

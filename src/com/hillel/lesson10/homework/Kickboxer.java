...
final public class Kickboxer extends ActionMovie {

    private String budget;
    private String filmCompany;

    public Kickboxer(String mainGenre, String producer, String filmName, String dateOfIssue, String budget, String filmCompany) {
